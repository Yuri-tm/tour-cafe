            ...
            <Card className="overflow-hidden">
              <CardContent className="p-0 h-full">
                <div className="p-3 flex flex-col justify-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Дипломированный и аккредитованный экскурсовoд; член Гильдии экскурсовoдов Республики Татарстан;<br></br> прошёл всероссийскую аттестацию экскурсовoдов в 2023г и включён в её официальный Реестр (вся информация доступна на бейдже с qr-кодом)
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <section className="mb-8">
          ...
          <div className="flex items-start gap-3">
            <div className="flex-1 flex flex-col gap-3">
              <Card className="overflow-hidden">
                <CardContent className="p-0">
                  <div className="aspect-[3/8] bg-contain bg-center flex items-start justify-center" style={{ backgroundImage: `url(${chuckChuckImg})` }}>
                    <h3 className="text-lg font-bold text-white-foreground text-center px-3 py-2 bg-card w-full">КОМПЛИМЕНТ от шеф-повара</h3>
                  </div>
                  <div className="p-3">
                  </div>
                </CardContent>
