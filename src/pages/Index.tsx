...
{ id: 3, name: "Татарская слобода", price: "3900 ₽", description: "Блюдо, вдохновлённое роскошью Казанского ханства. Изысканное сочетание традиционных татарских специй и благородных ингредиентов создаёт неповторимый вкус, достойный ханского стола. Настоящее кулинарное путешествие во времени." },
...
{ id: 5, name: "Туфелька Сююмбике", price: "3900 ₽", description: "Авторское блюдо от шеф-повара, созданное по старинным рецептам татарской кухни с использованием местных сезонных продуктов. Каждый ингредиент тщательно подобран для создания гармоничного и запоминающегося вкусового впечатления." },
...
{ id: 7, name: "Муха на окне", price: "4900 ₽", description: "Изысканное блюдо, вдохновлённое красотой природы Татарстана. Свежие локальные продукты, приготовленные с мастерством и любовью, раскрывают глубину и разнообразие татарской кулинарной традиции в каждом кусочке." },
