...
{ id: 9, name: "Казань на максималках", price: "17990 ₽", description: "Сезонное блюдо, меняющееся в зависимости от времени года. Шеф-повар использует только лучшие продукты текущего сезона, чтобы создать неповторимое гастрономическое впечатление, отражающее ритм природы Поволжья." },
