            ...
            <Card className="aspect-[1/2] overflow-hidden">
              <CardContent className="p-0 h-full">
                <div className="p-3 flex flex-col justify-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Коренной казанец, чистокровный татарин, настоящий патриот своей земли; дипломированный и аккредитованный экскурсовoд; член Гильдии экскурсовoдов Республики Татарстан; прошёл всероссийскую аттестацию экскурсовoдов в 2023г и включён в её официальный Реестр (вся информация доступна на бейдже с qr-кодом)
                  </p>
                </div>
              </CardContent>
            </Card>
